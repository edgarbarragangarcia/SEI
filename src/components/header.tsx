  ...
  return (
    <div className="fixed top-4 left-0 right-0 z-50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="rounded-xl bg-gradient-to-r from-white/95 via-white/90 to-white/95 shadow-lg px-4 md:px-6 py-2 border border-white/10 backdrop-blur-md">
          <header className="flex items-center justify-between h-16 bg-transparent text-gray-800 px-2 md:px-4">
            ...
            <nav className="flex items-center gap-2 text-sm font-semibold p-1 rounded-xl bg-white/30 backdrop-blur-sm">
              <Link
                href="/dashboard"
                className={cn(
                  "relative transition-colors px-4 py-1.5 rounded-lg",
                  pathname === "/dashboard"
